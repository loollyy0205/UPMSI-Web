...
export class PagAsaLocationComponent implements OnInit {
  ourFocus = [
    ...
    {img: 'https://dc585.4shared.com/img/i0TAjc82ea/s24/179ace95760/04-facilities?async&rand=0.9850710191897416', title: 'FACILITIES', content: `Since the Philippine’s occupation of the Pag-Asa Island in the 1970’s, the island remained severely underdeveloped compared to the smaller features in the Spratlys occupied by other claimant countries. Currently, the island has a weather station and naval station built in the 1970’s but has not been refurbished for four decades.`},
  ]
  constructor() { }
