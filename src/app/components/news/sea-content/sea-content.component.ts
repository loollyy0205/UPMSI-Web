...
@Component({
  selector: 'app-sea-content',
  templateUrl: './sea-content.component.html',
  styleUrls: ['./sea-content.component.css']
})
export class SeaContentComponent implements OnInit {
...
charlon = [{
  ...
  ngOnInit(): void {
   ...
   if(this.router.url.includes('/News/sea/Sea-cucumber-management')){
