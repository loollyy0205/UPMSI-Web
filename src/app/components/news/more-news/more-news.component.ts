...
export class MoreNewsComponent implements OnInit {
  news=[
    ...
    {image: "https://res.cloudinary.com/upmsi/image/upload/v1628147198/News/News%20Icons/News-04-narfleet_g3lebs.png", subtitle: 'April 30, 2021', title: "NARFleet is on its way to prowl Philippine waters", content: 'The National Academic Research Fleet (NARFleet) is set to embark on its first Expeditions. The program aims to provide better access to ocean research for both the...'},
