...
export class MoreScicommComponent implements OnInit {
  news=[
    ...
    {image: "https://res.cloudinary.com/upmsi/image/upload/v1632276488/News/Features/charlon/CHARLON-COVER-2_zlaavy.png",  title: "Underwater Cities: Studying coral propagation to rehabilitate coral communities", content: 'We often revere outer space as an expanse of wonder and mystery and look up at the...'},
