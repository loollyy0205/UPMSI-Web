...
export class MoreScicommComponent implements OnInit {
  news=[
    {image: "https://res.cloudinary.com/upmsi/image/upload/v1628066287/News/01-final-header_hjud3l.png",  title: "Against the Current: How the giant clams of the Philippines escaped extinction with the help of science and the community", content: 'The boundaries of science, including the...'},
    /**
