...
export class MoreScicommComponent implements OnInit {
  news=[
    {image: "https://res.cloudinary.com/dqs7gg03v/image/upload/v1628163389/News/scicomm/01-final-header_fiyzt5.png",  title: "Against the Current: How the giant clams of the Philippines escaped extinction with the help of science and the community", content: 'The boundaries of science, including the...'},
    /**
  ...
  newsContent(i){
    switch(i) {
      case 0:
        ...
        /**
      case 1:
        this.router.navigate(['/News/scicomm', 'UPMSI-scientists-receive-accolades-from-NAST']);
        break;
      case 2:
