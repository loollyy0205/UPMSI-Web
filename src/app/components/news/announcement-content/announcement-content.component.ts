...
export class AnnouncementContentComponent implements OnInit {
  deathAnniv = [{
    ...
    thumbnail: 'https://dc349.4shared.com/img/OFhmPV1oiq/s24/179b1ef0818/Announcement-01-article?async&rand=0.05329654336829037',
  ...
  emeriti = [{
    ...
    thumbnail: 'https://dc349.4shared.com/img/U_IOF2C8iq/s24/179b1ef5638/Announcement-04?async&rand=0.37668371544615264',
