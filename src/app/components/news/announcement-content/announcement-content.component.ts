...
export class AnnouncementContentComponent implements OnInit {
  ...
  dolomite = [{
    ...
    thumbnail: 'https://firebasestorage.googleapis.com/v0/b/upmsi-d03af.appspot.com/o/Announcement%2FAnnouncement-03-article-photo.png?alt=media&token=c03027a0-14f6-45d0-bbdb-8a0285178075',
