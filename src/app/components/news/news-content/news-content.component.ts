...
export class NewsContentComponent implements OnInit {
  deepestSpot = [{
    ...
    thumbnail: 'https://firebasestorage.googleapis.com/v0/b/upmsi-d03af.appspot.com/o/News%2FNews-01-scientist.png?alt=media&token=5f120f4e-9976-4e32-9f85-1c4306f17279',
