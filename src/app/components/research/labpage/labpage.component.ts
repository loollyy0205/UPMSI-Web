...
export class LabpageComponent implements OnInit {
  mmlb = [
    ...
    labHighBanner: 'https://dc592.4shared.com/img/dBN0TTYVea/s24/179ac81bbf0/highlight_heliopora_overgrowin?async&rand=0.06177846664782183',
  ...
  algae = [
    ...
    labHighBanner: 'https://dc588.4shared.com/img/eEM9X90Wea/s24/179ac7e9358/Epiphytes_IMG_6395?async&rand=0.050313054487366005',
