...
export class InstituteFocusComponent implements OnInit {
  instituteCont = [
    ...
    {img: 'https://res.cloudinary.com/dqs7gg03v/image/upload/v1624241415/About/about%20msi/06-teaching-icon_lx7k7t.jpg', title: 'TEACHING', content: `The UPMSI offers master's, doctorate, and professional master's programs to train future marine scientists, policymakers, and professionals in the private sector. Students may choose to specialize in Marine Biology, Marine Physical Sciences, or Marine Biotechnology.`},
    {img: 'https://res.cloudinary.com/dqs7gg03v/image/upload/v1624237982/About/about%20msi/05-extension-work_ygwn6j.png', title: 'EXTENSION', content: `The UPMSI regularly hosts workshops, conferences, and training courses on survey and monitoring techniques, coastal zone management, habitat restoration, mariculture, and science-based decision support systems. Public and private agencies can also consult the UP MSI for projects related to marine protection and management, biotechnology, and product development.`},
